...
static const unsigned char s_firstByteMark[7] = { 0x00, 0x00, 0xC0, 0xE0, 0xF0, 0xF8, 0xFC };
...
cJSON *cJSON_GetObjectItem(cJSON *object,const char *string)
{
    ...
    printf("**\r\n");
    return c;
}  // add if (!object) return 0; by lijun at 20180323
*/
